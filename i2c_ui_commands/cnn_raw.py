...
assert num_classes == 2, "Datasetet ska vara binärt"
...
model.save("cnn_vibrationTable.h5")
print("Model saved as cnn_vibrationTable.h5")
...
if not USE_SEQUENTIAL_SPLIT:
    ...
    plt.title("Confusion Matrix CNN vibration table")
    plt.show()
