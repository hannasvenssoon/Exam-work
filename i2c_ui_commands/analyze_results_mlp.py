...
ts_norm, gt_norm, pred_norm, lat_norm = parse_file("test_accuracy_mlp_normal.txt")
ts_abn,  gt_abn,  pred_abn,  lat_abn  = parse_file("test_accuracy_mlp_vib.txt")
...
cm_all = print_metrics("MLP merged tests", gt_all, pred_all)
print_latency("MLP merged", lat_all)
print_throughput("MLP merged", ts_all)

plot_confusion_matrix(
    cm_all,
    title="Confusion Matrix MLP",
    filename="mlp_confusion_merged.png"
)
...
plot_confusion_matrix(
    cm_norm,
    title="Confusion Matrix MLP vibration table use case",
    filename="mlp_confusion_normal.png"
)
...
plot_confusion_matrix(
    cm_abn,
    title="Confusion Matrix MLP for Abnormal test",
    filename="mlp_confusion_abnormal.png"
)


print("\nConfusion matrix plots saved:")
print("mlp_confusion_merged.png")
print("mlp_confusion_normal.png")
print("mlp_confusion_abnormal.png")
